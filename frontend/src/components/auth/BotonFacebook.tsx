...
export function BotonFacebook({ onAccessToken }: BotonFacebookProps) {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 bg-[#1877F2] px-4 py-2.5 text-sm font-medium text-white transition hover:bg-[#166fe0] disabled:opacity-60"
    >
