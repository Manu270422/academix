    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800">
      ...
      <nav className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
        <div className="mx-auto max-w-5xl px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold text-gray-900 dark:text-gray-100">Academix</span>
          </div>
      ...
      <section className="mx-auto max-w-5xl px-4 py-20 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            to="/login"
            className="rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-6 py-3 text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition"
          >
            Ya tengo cuenta
          </Link>
        </div>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-20">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((f) => (
            <div key={f.titulo} className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5 shadow-sm">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-100 text-brand-600 mb-3">
                {f.icon}
              </div>
              <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">{f.titulo}</h3>
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 py-6 text-center text-xs text-gray-500 dark:text-gray-400">
